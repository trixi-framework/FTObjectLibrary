...
!<
      ...
      CHARACTER(LEN=:), PARAMETER :: ASSERT_SIZE_DIFFERS_NAME   = "Array sizes differ"
      CHARACTER(LEN=:), PARAMETER :: ASSERT_VALUES_DIFFERS_NAME = "Array elements differ"
      CHARACTER(LEN=:), PARAMETER :: ASSERT_VALUES_OK_NAME      = "Arrays match"
