...
FTOL now has two versions, as necessary for procedures that need to distinguish between objects declared as TYPE and thos declared as CLASS. See the documentation and the tests for examples.
